...
(function () {
  ...
  .as-ia-warn{background:var(--mbu-warn-bg);border-color:var(--mbu-warn-border);color:#7a5200}
  .as-ia-dark{background:var(--mbu-error-bg);border-color:var(--mbu-error-border);color:#8a1f1f;font-weight:600}
  ...
  #as-switch-wrap{position:fixed;bottom:14px;right:14px;z-index:var(--mbu-z-pop);display:inline-flex;align-items:stretch;background:var(--as-acc);color:var(--mbu-text-on-accent);border-radius:20px;font:bold 13px var(--mbu-font);box-shadow:0 3px 12px rgba(40,20,80,.3);overflow:hidden}
  ...
  .as-cm-go.as-cm-repeat{background:#d9463f;border-color:#b53a34;color:var(--mbu-text-on-accent)}
  ...
  .as-dcmt{width:100%;box-sizing:border-box;font:13px inherit;border:1px solid var(--mbu-border);border-radius:var(--mbu-radius);padding:6px 9px;background:var(--mbu-bg-raised);color:#333}
  ...
  .as-srcing-lbl{font:600 12px var(--mbu-font);color:#2c7a59}
  .as-pdfban{position:absolute;right:6px;top:6px;z-index:4;background:#7a3a8f;color:var(--mbu-text-on-accent);font:700 10px/1 var(--mbu-font);letter-spacing:.5px;padding:3px 7px;border-radius:var(--mbu-radius);box-shadow:0 1px 3px rgba(0,0,0,.25);pointer-events:none}
  .as-newban{position:absolute;top:8px;right:-26px;transform:rotate(45deg);background:#1f9d6b;color:var(--mbu-text-on-accent);font:700 10px var(--mbu-font);letter-spacing:1px;padding:2px 26px;z-index:5;box-shadow:0 1px 3px rgba(0,0,0,.3);pointer-events:none}
  ...
  .as-undo{opacity:1;background:var(--mbu-bg);color:var(--as-acc);font-size:12px;font-weight:600}
  ...
  .as-pop-h{font-weight:600;color:#6a5b95;padding:3px 6px 6px;border-bottom:1px solid var(--mbu-divider);margin-bottom:4px}
  ...
  .as-search-pop .as-search-foot{margin-top:6px;padding:7px 6px 2px;border-top:1px solid var(--mbu-divider);font-size:11px;line-height:1.45;color:#9a8ccb}
  ...
  .as-src-prov-b{justify-content:flex-start;font-weight:600;color:var(--mbu-accent-deep);gap:8px}
  ...
  .as-bulk-cmt{width:100%;box-sizing:border-box;font:13px inherit;border:1px solid #d8ccf5;border-radius:var(--mbu-radius);padding:5px 8px;margin:2px 0 2px;background:var(--mbu-bg-raised);color:#333}
  /* lightbox */
  ...
  .as-lb-dl,.as-lb-dlcaret{font:600 13px var(--mbu-font);color:var(--mbu-text-on-accent);background:rgba(255,255,255,.08);border:1px solid transparent;height:34px;cursor:pointer}
  ...
  .as-lb-dlmenu button{text-align:left;background:none;border:none;color:#333;font:13px var(--mbu-font);padding:7px 10px;border-radius:var(--mbu-radius);cursor:pointer}
