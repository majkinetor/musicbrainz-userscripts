...
//
//   node dev/ui/shoot-ui.mjs                # light + dark
//   node dev/ui/shoot-ui.mjs --light        # light only
//   node dev/ui/shoot-ui.mjs --only art_station
//
...
await writeFile(resolve(OUT, 'README.md'), [
    '# UI screenshots (#564)',
    '',
    'Generated by `node dev/ui/shoot-ui.mjs`. Numbers are stable and belong to the',
